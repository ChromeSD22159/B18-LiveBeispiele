...
fun main(){
    ...
    val anzahlAnAs: Int = name.uppercase().count { it -> it == 'A'}   // zählt wie oft 'A' im Namen ist
    ...
    // Derselbe Filter mit Schleife statt Lambda:
    ...
    val sortimentMap = sortiment.toMap().toMutableMap()

    // Apple Produkte zählen
    val anzahlAppleProdukte = sortimentMap.count{ (name, preis) ->
        name.contains("Apple") || name.contains("iPhone")
    }
