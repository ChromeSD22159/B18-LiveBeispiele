...
fun main() {
    ...
    val licht1An = getRandomBoolean()
    val licht2An = getRandomBoolean()

    val person1 = getRandomPerson()
    val person2 = getRandomPerson()

    getRandomPerson()   // Diese zufällige Person wird nicht abgespeichert
...
fun getRandomPerson(): Pair<String, Int> {
    val name = getRandomName()
    val alter = (22..55).random()
    val person =  Pair(name,alter)
    return person
}

fun readPerson(): Pair<String, Int>{
    println("Geben sie ihren Namen und Alter ein, mit ',' getrennt")
    val eingabe = readln().split(',')
    val name = eingabe[0]
    val alter = eingabe[1].toInt()

/*    println("Geben sie ihren Alter ein:")
