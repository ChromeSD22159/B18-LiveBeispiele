...
//    var spieler1: String = namensGenerator()
...
// --------------------------
// Ein kleiner Kampf zw. Genger und Pikachu
...
fun pikachuAttackenAuswahl() {
    ...
    val pikachuAtks = mutableMapOf(
        "Donnerschock" to 40..50,
        "Ruckzuckhieb" to 60..80,
        "Donner" to 120..140
    )
    ...
    val schaden: Int = pikachuAtks[attacke]!!.random()
//    val schaden: Int = pikachuAtks.getValue(attacke).random()
