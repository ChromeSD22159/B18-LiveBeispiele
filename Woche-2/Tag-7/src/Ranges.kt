...
fun main(){
    ...
    // Jeden 2. Spieler ausdrucken
    println(players.slice(players.indices step 2))

//    val computerHand = listOf("Schere", "Stein", "Papier").random()


    val lottoZahlen = (0..50).toList()
    ...
    val alphabet = charRange.toList()// enthält alle Buchstaben von a bis z
