...
fun aufgabe1(){
    ...
    """.trimIndent()
    println("${BOXED}${RED_BACKGROUND}$boardingPass$reset")
...
fun aufgabe2(){
    ...
    println("Ihr Kontostand vor der Transaktion: $kontoStand")
...
fun aufgabe3(){
    ...
    /*
    Das Flugzeug hat 130 Sitzplätze, wie viele 4-köpfige Familien können mit dem Flugzeug mitgenommen werden?
    TODO: Gib das Ergebnis auf der Konsole aus.
    */
    val sitzPlaetze: Int = 130
    val familien: Int = sitzPlaetze / 4
//    val freieSitzplaetze = sitzPlaetze - familien * 4
    val freieSitzplaetze = sitzPlaetze % 4
    println("Bei $sitzPlaetze Sitzplätzen passen $familien Gruppen ins Flugzeug. $freieSitzplaetze Sitze bleiben frei.")
    ...
    */
    val preisProKM = 16.00  // readln().toDouble()
    val distanz = 1034.93
